...
USING 
    (
    SELECT ROUND(TO_CHAR(CURRENT_TIMESTAMP(),'YYYYMMDD'))::DOUBLE,
        ...
        (CASE t15.ASSIGNEDPRICELEVEL
         ...
         ELSE 'FALSE'
         END)::VARCHAR(7),
           (t15.QUANTITY::NUMBER(19,0))::DOUBLE,
           (t15.SALEUNIT::NUMBER(19,0))::DOUBLE,
           t15.UNITPRICE::NUMBER(28,2),
           t15._FIVETRAN_SYNCED,
           CURRENT_TIMESTAMP()
...
ON ((((("FACT_CUSTOMER_PRODUCT_PRICE"."DATE_KEY"::DOUBLE) = t17.t17c0) 
AND (("FACT_CUSTOMER_PRODUCT_PRICE"."CUSTOMER_KEY"::DOUBLE) = t17.t17c1)) 
AND (("FACT_CUSTOMER_PRODUCT_PRICE"."PRODUCT_KEY"::DOUBLE) = t17.t17c2)) 
AND (("FACT_CUSTOMER_PRODUCT_PRICE"."LOCAL_CURRENCY_KEY"::DOUBLE) = t17.t17c3))
AND (("FACT_CUSTOMER_PRODUCT_PRICE"."PRICE_LEVEL_KEY"::DOUBLE) = t17.t17c4) 
AND NOT (0 = 
    (CASE 1
         WHEN 1
         THEN 1
...
WHEN MATCHED 
AND 1 = 1 THEN
 UPDATE SET "FACT_CUSTOMER_PRODUCT_PRICE"."PRICE_LEVEL_ASSIGNED_INDICATOR" = t17.t17c5, "FACT_CUSTOMER_PRODUCT_PRICE"."QUANTITY_COUNT" = t17.QUANTITY, "FACT_CUSTOMER_PRODUCT_PRICE"."SALE_UNIT_COUNT" = t17.SALEUNIT, "FACT_CUSTOMER_PRODUCT_PRICE"."LOCAL_CURRENCY_UNIT_PRICE_AMOUNT" = t17.UNITPRICE, "FACT_CUSTOMER_PRODUCT_PRICE"."SOURCE_EXTRACT_DATETIME" = t17._FIVETRAN_SYNCED, "FACT_CUSTOMER_PRODUCT_PRICE"."LAST_MODIFIED_DATETIME" = t17.t17c10 
